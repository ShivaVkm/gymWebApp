...
def Index(request):
    ...
    # # print(enquiry)
    # data = serializers.serialize('json',enquiry)
    ...
    d = {'e1': e1, 'p1': p1, 'eq1': eq1, 'm1': m1, 't1':t1}
...
def Add_Member(request):
    ...
    if request.method == "POST":
        ...
        try:
            Member.objects.create(name=n, contact=c, emailid=e, age=a, gender=g, plan=plan, joindate=j, expiredate=ex,
                                initialamount=i)
            error = "no"
        except:
            error = "yes"
...
def Add_Trainer(request):
    ...
    if request.method == "POST":
        ...
        try:
            Trainer.objects.create(name=n, contact=c, emailid=e, age=a, gender=g, joindate=j, expiredate=ex,
                                initialamount=i)
            error = "no"
        except:
            error = "yes"
